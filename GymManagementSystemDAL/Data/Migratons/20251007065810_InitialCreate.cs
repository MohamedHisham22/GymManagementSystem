        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JoinDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SysDateTime()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck", "[Phone] not like '%[^0-9]%' and [Phone] like '01%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "varchar(50)", maxLength: 50, precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("DurationDaysCheck", "[DurationDays] between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HireDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SysDateTime()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Name = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Email = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    Phone = table.Column<string>(type: "varchar(11)", maxLength: 11, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck1", "[Phone] not like '%[^0-9]%' and [Phone] like '01%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberShip", x => new { x.MemberId, x.PlanId, x.StartDate });
                    table.ForeignKey(
